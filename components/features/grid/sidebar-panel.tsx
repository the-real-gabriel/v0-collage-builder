                  ...
                  <div className="space-y-4 p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-1 mb-2">
                        ...
                        <Button
                          variant="outline"
                          className="h-auto py-1 px-2 flex flex-col items-start justify-center btn-subtle border-dashed border-black/20"
                          onClick={onReset}
                          size="sm"
                        >
                          <div className="w-full flex items-center justify-between">
                            <span className="font-medium text-xs">Clear</span>
                            <div className="border rounded-sm border-black/10 bg-black/5 w-4 h-4 flex items-center justify-center">
                              <RefreshCw className="h-2 w-2 text-black/40" />
                            </div>
                          </div>
                          <span className="text-[10px] w-full text-black/50">Reset</span>
                        </Button>
                      </div>
                    </div>
                  </div>
